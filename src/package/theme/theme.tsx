...
export class Theme implements ITheme {
  ...
  constructor(theme: ITheme) {
    this.spacing = theme.spacing || SpacingTypes.regular
    this.type = theme.type || Types.light
    Object.freeze(this)
  }
...
export function withTheme<Props>(Component: React.ComponentClass<Props & IProps>): React.FunctionComponent<Props> {
  return (props: Props) => (
    <ThemeConsumer>
      {(theme: Theme) => {
